...
export const Ejercicios1Page = () => {
  ...
  return (
    <div className="fondo">
      ...
      <div className="divcontenido">
        ...
        <div className="divf">
          <div className="divtexto">
            <br />
            Para mantener un cuerpo sano es importante hacer ejercicio todos los
            días
          </div>
        </div>
      </div>
      ...
      >
        <div className="">
          <button className="button" onClick={irAEPaginaCatu}>
            ANTERIOR{" "}
          </button>
        </div>
        <div className="">
          <button className="button" onClick={irAEjercicios2}>
            SIGUIENTE{" "}
          </button>
        </div>
      </div>

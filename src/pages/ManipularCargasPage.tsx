...
export const ManipularCargas = () => {
    ...
    const irAtras=()=>{
      ...
      return (
        ...
        <div className="col-auto p-5 text-center" style={{ backgroundColor: '#2A728B',width:'65%', borderRadius:'30px', borderStyle: 'solid', borderColor:'white', borderWidth: '2px'}}>
            
            <div className="row justify-content-center align-items-center" >
                <div><h1 style={{ color:'white'}}><b>¿QUÉ ES MANIPULAR CARGAS?</b></h1></div>
            </div>
          ...
          <div className="row">
            ...
            <div className="container" style={{ backgroundColor: '#FFFFFF',borderStyle: 'solid', borderColor:'#03384B', borderWidth: '7px'}}>
